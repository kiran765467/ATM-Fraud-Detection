...
<?php } ?>else{ ?>
		<form method="post">
			...
			<input type="text" name="mobile_no" value="<?php echo !empty($recepient_no)?$receipient_no:''; ?>" <?php echo ($otpDisplay == 1)?'readonly':'';
			?>/>
			
			<?php if($otpDisplay == 1){ ?>
			<label>Enter OTP</label>
			<input type="text" name="otp_code"/>
			<a href="javascripit:void(0);" class="resend">Resend OTP </a>
			<?php}?>
